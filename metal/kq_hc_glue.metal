...
instantiate_kernel("kq_hc_front_expand_collapse_bfloat16_t", kq_hc_front_expand_collapse, bfloat16_t)
instantiate_kernel("kq_hc_front_expand_collapse_float16_t", kq_hc_front_expand_collapse, float16_t)
