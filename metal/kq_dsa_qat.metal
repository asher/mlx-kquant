...
#define instantiate_kq_dsa_indexer_qat_pack(tname, dtype) \
  instantiate_kernel(                                     \
      "kq_dsa_indexer_qat_pack_" #tname, kq_dsa_indexer_qat_pack, dtype)

instantiate_kq_dsa_indexer_qat_pack(float16_t, half);
instantiate_kq_dsa_indexer_qat_pack(bfloat16_t, bfloat16_t);
instantiate_kq_dsa_indexer_qat_pack(float, float);
// clang-format on
